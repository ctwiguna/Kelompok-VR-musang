...
public class TicketInteraction : MonoBehaviour, IInteractable
{
    ...
    // Tambahkan properti publik/statis agar status tiket bisa dibaca oleh script lain
    public static bool HasTicket { get; private set; } = false;
    ...
    {
        hasTicket = true;
        HasTicket = true; // Update status global
